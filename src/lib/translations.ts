...
export const translations: Record<Language, TranslationDictionary> = {
  en: {
    ...
    footer: {
      ...
      paymentQrClearance: "Payment & QR Clearance",
      allRightsReserved: "All rights reserved.",
      paymentsAccepted: "Payments: bKash · Nagad · Cards",
      location: "Dhaka, Bangladesh 🇧🇩",
      brandBlurb:
        "Curated domestic tours across Bangladesh — trusted local hosts, transparent pricing, and seamless QR payment clearance.",
    ...
    booking: {
      ...
      qrClearanceNotice: "Pay the remaining balance securely on tour day via QR scan.",
  ...
  bn: {
    ...
    footer: {
      ...
      paymentQrClearance: "পেমেন্ট ও কিউআর ক্লিয়ারেন্স",
      allRightsReserved: "সর্বস্বত্ব সংরক্ষিত।",
      paymentsAccepted: "পেমেন্ট মাধ্যম: বিকাশ · নগদ · কার্ডস",
      location: "ঢাকা, বাংলাদেশ 🇧🇩",
      brandBlurb:
        "সারা বাংলাদেশে বাছাইকৃত অভ্যন্তরীণ ভ্রমণ — বিশ্বস্ত স্থানীয় হোস্ট, স্বচ্ছ মূল্য এবং নির্বিঘ্ন কিউআর পেমেন্ট ক্লিয়ারেন্স।",
    ...
    booking: {
      ...
      qrClearanceNotice: "ট্যুরের দিনে কিউআর স্ক্যান করে বাকি অর্থ নিরাপদে পরিশোধ করুন।",
